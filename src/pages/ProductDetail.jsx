  ...
  if (loading) return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "60vh", direction: "rtl", fontFamily: "'Segoe UI', Tahoma, sans-serif" }}>
      <div style={{ textAlign: "center" }}>
        <img src="/logo.png" alt="" style={{ height: "60px", opacity: 0.4, marginBottom: "16px" }} onError={e => e.target.style.display = "none"} />
        <p style={{ color: "#888" }}>جاري تحميل المنتج...</p>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ direction: "rtl", fontFamily: "'Segoe UI', Tahoma, sans-serif", background: "#f5f7f5", minHeight: "100vh" }}>
      ...
      <div style={{ background: `linear-gradient(90deg, ${GREEN}, #245f38)`, padding: "12px 28px", display: "flex", alignItems: "center", gap: "10px" }}>
        <img src="/logo.png" alt="" style={{ height: "28px" }} onError={e => e.target.style.display = "none"} />
        <span style={{ color: GOLD, fontSize: "13px", fontWeight: "700" }}>ARAB DECORATION</span>
      </div>

      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "28px 24px" }}>

        {/* Breadcrumb */}
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "24px", fontSize: "13px", color: "#888", flexWrap: "wrap" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0", background: "#fff", borderRadius: "20px", overflow: "hidden", boxShadow: "0 4px 24px rgba(0,0,0,0.09)", border: `1px solid #e8ede8` }}>
          ...
          <div style={{ position: "relative", minHeight: "400px", background: `linear-gradient(135deg, #e8f0e8, #d4e4d4)` }}>
            ...
            {/* Category Badge */}
            <div style={{ position: "absolute", top: "14px", right: "14px", background: "rgba(27,77,46,0.85)", backdropFilter: "blur(8px)", padding: "6px 14px", borderRadius: "20px", fontSize: "12px", fontWeight: "700", color: GOLD }}>
              {catInfo.icon} {catInfo.label}
            </div>
            {product.show_home === 1 && (
              <div style={{ position: "absolute", top: "14px", left: "14px", background: `linear-gradient(135deg, ${GOLD}, ${GOLD2})`, padding: "5px 12px", borderRadius: "20px", fontSize: "11px", fontWeight: "700", color: GREEN }}>
                ⭐ مميز
              </div>
            )}
          </div>
          ...
          <div style={{ padding: "36px 32px", display: "flex", flexDirection: "column" }}>
            {/* Logo small */}
            <img src="/logo.png" alt="" style={{ height: "32px", objectFit: "contain", marginBottom: "16px", alignSelf: "flex-start" }} onError={e => e.target.style.display = "none"} />

            <h1 style={{ margin: "0 0 10px", fontSize: "24px", color: GREEN, lineHeight: "1.3", fontWeight: "800" }}>{product.name}</h1>

            <div style={{ fontSize: "28px", fontWeight: "900", color: GOLD, margin: "0 0 16px" }}>{product.price}</div>
